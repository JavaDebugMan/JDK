 ...
 * integer values.  Each bit of an operation set denotes(表示) a category of
 * selectable operations that are supported by the key's channel.
 *
 * <ul>
 *
 * <li><p> The <i>interest set</i> determines(确定) which operation categories will
 * be tested for readiness(敏捷,迅速) the next time one of the selector's selection
 ...
 * <i>attachment</i> of a single arbitrary(任意的) object to a key.  An object can be
