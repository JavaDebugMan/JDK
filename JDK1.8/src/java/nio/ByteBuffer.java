 ...
 * single bytes; </p></li>
 *
 * <li><p> Relative {@link #get(byte[]) <i>bulk(大部分) get</i>}
 ...
 * avoid copying the buffer's content to (or from) an intermediate(中间的) buffer
 * before (or after) each invocation of one of the underlying operating
 * system's native I/O operations.
 *
 * <p> A direct byte buffer may be created by invoking the {@link
 * #allocateDirect(int) allocateDirect} factory method of this class.  The
 * buffers returned by this method typically have somewhat(几分,有点) higher allocation
 * and deallocation(存储单元重新分配) costs than non-direct buffers.  The contents of direct
 ...
 *
 * <p> For access to heterogeneous(多相的,异种的) binary data, that is, sequences of values of
 ...
 * <a name="views"></a>
 *
 * <p> For access to homogeneous(均匀的,同样的) binary data, that is, sequences of values of
